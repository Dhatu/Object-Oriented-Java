...
public class Part2 {
	    ...
	    public static void main(String[] args)
	    {
	        ...
	        String phone_number_final = getDigits(initial_phone_number);

	        System.out.printf("%nOutput phone number for '%s' is '%s'",
	                initial_phone_number, phone_number_final);
	    }

		public static String getDigits(String initial_phone_number){
	    {
	        long number = 0;
            ...
            String initial_phone_number1 = Long.toString(number);
			return initial_phone_number1;
